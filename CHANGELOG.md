...
- Implicit SwiftUI matches can be disabled
  [Alessandro Calzavara](https://github.com/dral3x).
  [#35](https://github.com/dral3x/StringsLint/pull/35).

- NSLocalizedString with value
  [Alessandro Calzavara](https://github.com/dral3x).
  [#36](https://github.com/dral3x/StringsLint/pull/36).

- Add match for String(localized:)
  [Alessandro Calzavara](https://github.com/dral3x).
  [#37](https://github.com/dral3x/StringsLint/pull/37).
